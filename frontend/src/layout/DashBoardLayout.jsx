...
const sharedLinks = (
  <>
    ...
    <li>
        <Link to="/hacker"><FaCartShopping/> Hacker</Link>
    </li>
   
    <li>
        <Link to="/contact"><FaQuestionCircle/> Customer Support</Link>
    </li>
  </>
);
    ...
    <div>
    {
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
          ...
          <li>
            <Link to="/dashboard/hackerlist">
              <FaShoppingBag /> Manage Hackers
            </Link>
          </li>
